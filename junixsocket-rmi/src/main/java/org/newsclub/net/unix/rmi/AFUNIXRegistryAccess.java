...
abstract class AFUNIXRegistryAccess {
   ...
   * @see AFUNIXRegistry#lookup(String)
   */
   ...
   * @throws MalformedURLException upon error
   * @throws RemoteException upon error
   * @see AFUNIXRegistry#lookup(String, long, TimeUnit)
   */
   ...
   * @throws NotBoundException upon error
   * @throws MalformedURLException upon error
   * @see AFUNIXRegistry#unbind(String)
   */
   ...
   * @throws MalformedURLException upon error
   * @see AFUNIXRegistry#bind(String, Remote)
   */
   ...
   * @throws RemoteException upon error
   * @throws MalformedURLException upon error
   * @see AFUNIXRegistry#rebind(String, Remote)
   */
   ...
   * 
   * Unlike {@link AFUNIXRegistry#list()}, in case the registry has been shut down already, an empty
   * array is returned.
   * 
