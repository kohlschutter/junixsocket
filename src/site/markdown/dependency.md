...
## Gradle
 ...
 Minimum requirement:
    ...
    compile 'com.kohlschutter.junixsocket:junixsocket-core:2.3.1'
 
 For RMI support, add:
 
    compile 'com.kohlschutter.junixsocket:junixsocket-rmi:2.3.1'
 
 For MySQL support, add:
 
    compile 'com.kohlschutter.junixsocket:junixsocket-mysql:2.3.1'
 ...
 * (typically, omit if you use the custom library below) junixsocket-native-common-2.3.1.jar
 * (optionally, if you have a custom architecture) junixsocket-native-custom-2.3.1.jar
