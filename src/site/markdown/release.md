...
Use the provided script to copy the corresponding nar to a project folder:
    ...
    cd junixsocket
    # replace 2.3.1 with the desired version number
    junixsocket-native-prebuilt/bin/copy-nar-from-m2repo.sh 2.3.1
...
The files can be found in
   ...
   * `junixsocket/junixsocket-dist/target/junixsocket-dist-2.3.1-bin`
   * `junixsocket/junixsocket-dist/target/junixsocket-dist-2.3.1-bin.tar.gz`
   * `junixsocket/junixsocket-dist/target/junixsocket-dist-2.3.1-bin.zip`
...
3. Release title = "junixsocket" + version>, e.g., "junixsocket 2.3.1"
